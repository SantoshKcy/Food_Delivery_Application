...
class _WishlistViewState extends State<WishlistView> {
  List<WishlistItem> wishlistItems = [
    WishlistItem(name: "Chicken Biryani", price: 300, image: "assets/images/chicken-biryani.jpg"),
    WishlistItem(name: "Chicken Tandoori", price: 320, image: "assets/images/chicken_tandoori.jpg"),
    WishlistItem(name: "Chilly Momo", price: 380, image: "assets/images/chilly_momo.jpg"),
  ];
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    "Rs. ${item.price}",
                    style: const TextStyle(fontSize: 14, color: Color(0xFFFF7918), fontWeight: FontWeight.bold),
                  ),
                ],
              ),
            ),
