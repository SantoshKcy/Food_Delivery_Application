...
class EditProfileView extends StatelessWidget {
  ...
  final TextEditingController firstNameController = TextEditingController(text: "Santosh");

  final TextEditingController lastNameController = TextEditingController(text: "KC");

  final TextEditingController emailController = TextEditingController(text: "santosh@gmail.com");

  final TextEditingController phoneController = TextEditingController(text: "9840922949");
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildTextField("Email", emailController, isDarkMode, isReadOnly: true),
            _buildTextField("Phone", phoneController, isDarkMode),
            const SizedBox(height: 20),

            _buildSectionTitle("Change Password", isDarkMode),
            _buildTextField("Current Password", currentPasswordController, isDarkMode, isPassword: true),
            _buildTextField("New Password", newPasswordController, isDarkMode, isPassword: true),
            _buildTextField("Confirm Password", confirmPasswordController, isDarkMode, isPassword: true),
            const SizedBox(height: 20),
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          ...
          focusedBorder: OutlineInputBorder(
            borderRadius: BorderRadius.circular(10),
            borderSide: BorderSide(color: isDarkMode ? Colors.orangeAccent : const Color(0xFFFF7918)),
          ),
        ),
